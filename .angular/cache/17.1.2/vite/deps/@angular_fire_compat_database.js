...
import {
  ...
  ɵlazySDKProxy,
  ɵzoneWrap
} from "./chunk-EFRE3TW6.js";
import {
  firebase
} from "./chunk-EMSBT2S3.js";
import "./chunk-RINJYZLI.js";
import {
  Component,
  ComponentContainer,
  Deferred,
...
} from "./chunk-O776ABPR.js";
import {
  isPlatformServer
} from "./chunk-QKSBAYH5.js";
import {
  Inject,
  Injectable,
  InjectionToken,
...
import {
  ...
  timer,
  withLatestFrom
} from "./chunk-J4XZHY45.js";
import {
  Observable,
  Subject
} from "./chunk-MK4VTHYS.js";
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name4, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-KELCXRR2.js"))), map(() => ɵfirebaseAppFactory(options, zone, name4)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
